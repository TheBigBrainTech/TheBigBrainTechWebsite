            ...
            <section className="bg-gray-200 h-[800px] flex items-center pt-8 mt-16" style={{ backgroundImage: `url(${Character})`, backgroundSize:'cover', backgroundRepeat:'no-repeat' }}>
                ...
                <div className="flex-1 pl-8 text-center bg-gray-100/90 rounded-2xl">
                    <div className="text-secondary">
                        <p className="text-3xl text-gray-600 font-bold p-7">MASTER QA AUTOMATION FROM INDUSTRY
                            LEADERS</p>
                        <p className="text-gray-600 text-xl p-5">Learn from experienced QA automation engineers who
                            apply real-world expertise in the classroom. Each mentor is committed to offering tailored
                            feedback and support, helping you reach your professional objectives.</p>
                        <p className="text-gray-600">We offer a structured path to acquire essential QA automation
                            skills, making you competitive and ready to secure a high-paying job in the tech sector.</p>
                ...
                >
                    <div className="bg-white p-4 rounded-lg shadow-lg mr-10 min-h-max">
                        <h1 className="mb-3 font-bold text-4xl text-center text-gray-600">QA Automation Engineer</h1>
                        <h4 className="mb-8 text-xl text-start text-gray-500">
                            Enhance your Quality Assurance skills, explore advanced frameworks, and receive guidance
                            from
                        ...
                        <div className="grid grid-cols-3 gap-6 text-blue-500 p-6">
                            <div className="text-center">
                                <FontAwesomeIcon icon={faJava} size="2xl" className="mb-2"/>
                                <p className="text-sm">Java</p>
                            </div>
                            <div className="text-center">
                            <Icon name="maven" size="44px" color="currentColor" className="ml-10"/>
                                <p className="text-sm">Maven</p>
                            </div>
                            <div className="text-center">
                                <Icon name="selenium" size="24px" color="currentColor" className="mb-2 ml-12"/>
                                <p className="text-sm">Selenium</p>
                            </div>
                            <div className="text-center">
                                <Icon name="cucumber" size="24px" color="currentColor" className="mb-2 ml-12"/>
                                <p className="text-sm">Cucumber</p>
                            </div>
                            <div className="text-center">
                                <Icon name="testng" size="34px" color="currentColor" className="ml-12"/>
                                <p className="text-sm">TestNG</p>
                            </div>
                            <div className="text-center">
                                <Icon name="postman" size="44px" color="currentColor" className="ml-10"/>
                                <p className="text-sm">Postman</p>
                            </div>
                            <div className="text-center">
                                <Icon name="restassured" size="24px" color="currentColor" className="mb-2 ml-12"/>
