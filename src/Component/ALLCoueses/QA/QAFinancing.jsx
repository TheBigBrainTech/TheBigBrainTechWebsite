                ...
                <div className="p-4">
                    {key === "tuition" && (
                        <div>
                            ...
                            <h2 className="text-xl font-bold">Tuition Fee: $1,500.00</h2>
                            <h2 className="text-xl font-bold">Enrollment Fee: $100.00</h2>
                            <h2 className="text-xl font-bold">Total: $1600.00</h2>
                    ...
                    {key === "financing" && (
                        <div>
                            ...
                            <p>Pay in 8 installments of - $187.50</p>
                            <h2 className="text-xl font-bold mt-4">Option 2</h2>
                            <p>Pay in 4 installments of - $375.00</p>
                            <p className="text-gray-500">
                                0% Interest if paid within 8 Weeks of starting Bootcamp
                                <sup>*</sup>
                            </p>
                            <p className="mt-4 text-gray-400">
                                <sup>*</sup>The $100 enrollment fee is NOT a part of your overall tuition.<br></br>
                    ...
                    {key === "college" && (
                        <div>
                            ...
                            <p>
                                We offer a special discount of $250 for current college students. To qualify, please provide a valid student ID and proof of enrollment.
                            </p>
                            ...
                            <p className="text-gray-500 mt-4">
                                <sup>*</sup>The discount is only applicable for full-time college students, recent graduates (within 1 year of graduation) and cannot be combined with other scholarships or financial aids.
                            </p>
                        </div>
                    )}
                </div>
