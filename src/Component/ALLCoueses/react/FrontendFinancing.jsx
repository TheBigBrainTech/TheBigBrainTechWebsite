                ...
                <div className="p-4">
                    {key === "tuition" && (
                        <div>
                            ...
                            <h2 className="text-xl font-bold">Tuition Fee: $2,000.00</h2>
                            <h2 className="text-xl font-bold">Enrollment Fee: $100.00</h2>
                            <h2 className="text-xl font-bold">Total: $2100.00</h2>
                    ...
                    {key === "financing" && (
                        <div>
                            ...
                            <p>Pay in 8 installments of - $250.00</p>
                            <h2 className="text-xl font-bold mt-4">Option 2</h2>
                            <p>Pay in 4 installments of - $500.00</p>
...
export default FrontendFinancing;
