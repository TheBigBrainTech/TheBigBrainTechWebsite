            ...
            <section className="bg-gray-200 h-[800px] flex items-center pt-8 mt-16" style={{ backgroundImage: `url(${Character})`, backgroundSize:'cover', backgroundRepeat:'no-repeat' }}>
                ...
                <div className="flex-1 pl-8 text-center bg-gray-100/90 rounded-2xl">
                    <div className="text-secondary">
                        ...
                        <p className="text-gray-600 text-xl p-5">Gain knowledge from Fullstack Engineer&apos;s who bring practical, real-world experience into the classroom. Each instructor is dedicated to providing personalized feedback and support, ensuring you achieve your goals every step of the way.</p>
                ...
                >
                    <div className="bg-white p-4 rounded-lg shadow-lg mr-10 min-h-max">
                        <h1 className="mb-3 font-bold text-4xl text-center text-gray-600 ">Fullstack Engineer</h1>
                        <h4 className="mb-8 text-xl text-start text-gray-500">
                            Enhance your app development skills, explore advanced frameworks,libraries, and receive guidance from
                            expert mentors for a successful tech career—all through an online Live Bootcamp.
                        </h4>
                        <p className="text-2xl text-gray-600">Learn The Web Application Development Fundamentals</p>
                        <div className="flex-1 text-blue-500 flex justify-around items-center p-6 item-xl">
                            ...
                            <div className="text-center">
                                <FontAwesomeIcon icon={faNode} size="2xl" className="mb-2"/>
                            ...
                            <div className="text-center">
                                <FontAwesomeIcon icon={faCircleNodes} size="2xl" className="mb-2"/>
