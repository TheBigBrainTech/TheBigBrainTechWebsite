                    ...
                    <div className="p-4">
                        {key === "tuition" && (
                            <div>
                                ...
                                <h2 className="text-xl font-bold">Tuition Fee: $800.00</h2>
                                ...
                                <h2 className="text-xl font-bold">Total: $900.00</h2>
                        ...
                        {key === "financing" && (
                            <div>
                                ...
                                <p>Pay in 2 installments of - $400.00</p>
                                <h2 className="text-xl font-bold mt-4">Option 2</h2>
                                <p>Pay in 4 installments of - $200.00</p>
...
export default EarlyLearners3Financing;
