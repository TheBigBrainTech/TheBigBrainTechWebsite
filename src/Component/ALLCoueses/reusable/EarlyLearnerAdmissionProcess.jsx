            ...
            <div className="container mx-auto py-8">
                ...
                >
                    <div className="flex flex-col justify-center items-center text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-gray-700 mt-2 text-center">
                                    Our course is perfect for beginners. All you need is enthusiasm and a love for
                                    learning!
                                </p>
                            </div>
                            <div className="flex flex-col items-center">
                        ...
                        <div>
                            <p className="text-gray-500 pt-4"><sup>*</sup>prerequisite for Early Learner 2 is Early
                                learner 1 and for Early Learner 3 is Early learner 2
                            </p>
