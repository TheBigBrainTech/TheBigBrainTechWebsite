                ...
                <div className="flex flex-wrap text-gray-700 bg-gray-100 p-3">
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/3 mb-4 p-2">
                        ...
                        <p>
                            ...
                            <br></br>
                            <ul>
                                <li><strong>Expert Guidance</strong>: Acquire the skills to become a junior full-stack
                                    web developer.
                                </li>
                                <li><strong>Self-Paced Pre-Work</strong>: Understand software engineering fundamentals
                                    before class starts.
                                </li>
                                <li><strong>Comprehensive Coursework</strong>: Access lesson decks and project toolkits
                                    for continuous learning.
                                </li>
                                <li><strong>Project Portfolio</strong>: Create professional-grade projects to showcase
                                    your abilities.
                                </li>
                                <li><strong>Personalized Support</strong>: Receive feedback and assistance from
                                    instructors and teaching assistants.
                                </li>
                                <li><strong>Career Services</strong>: Get help with job search, technical challenges,
                                    and salary negotiations.
                                </li>
                                <li><strong>Interview Prep</strong>: Benefit from resume reviews, mock interviews, and
                                    whiteboarding practice.
                                </li>
                                <li><strong>Alumni Benefits</strong>: Enjoy discounts, networking events, and career
                                    workshops.
                                </li>
                                <li><strong>Course Certificate</strong>: Earn a certificate to showcase your skills on
                                    LinkedIn.
                                </li>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/3 mb-4 p-2">
                        ...
                        <p>
                            The Bigbrain Tech&apos;s Early Learner program is designed to give young minds a head start in
                            the tech industry. By joining this bootcamp, you&apos;ll gain valuable skills in programming and
                            web development, setting a strong foundation for your future career. Our engaging and
                            hands-on curriculum is tailored to young learners, ensuring that you understand key concepts
                            while having fun. Plus, you&apos;ll get to work on real-world projects, receive guidance from
                            expert instructors, and connect with a community of like-minded peers. Whether you&apos;re
                            looking to explore a potential career path or simply want to enhance your tech skills, this
