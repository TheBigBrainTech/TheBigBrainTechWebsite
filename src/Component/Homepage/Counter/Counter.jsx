...
import {faChildReaching, faLaptopFile, faUserPlus, faUsers} from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className="w-full md:w-1/4 px-4 mb-4 md:mb-0">
                        <div className="bg-white p-4 rounded shadow-md h-full flex flex-col">
                            <div className="text-center flex-grow">
                                ...
                                <p className="text-neutral-500 pb-4">Got Hired In First Six Months of Completion At
                                    Fortune 500</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-1/4 px-4 mb-4 md:mb-0">
                        <div className="bg-white border-l border-gray-200 p-4 rounded shadow-md h-full flex flex-col">
                            <div className="text-center flex-grow">
                                ...
                                <p className="text-neutral-500 pb-4">Successfully Completed Our Early Learners
                                    Program</p>
                            </div>
                        </div>
                    </div>
