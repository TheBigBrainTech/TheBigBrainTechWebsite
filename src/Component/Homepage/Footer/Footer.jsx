        ...
        <section className="p-6 bg-gray-100 flex justify-center items-center min-h-45 border-b-2">
          <div className="container mx-auto flex flex-wrap items-start justify-center space-x-6">
            ...
            <motion.div
                ...
                whileHover={{scale: 1.05}}
            >
              <p className="font-bold text-center text-2xl text-gray-600 mb-4">Don&apos;t Miss Out On Offers and
                Discounts</p>
            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-6/12 mb-8">
                ...
                <p className="px-3">
                  ...
                  are actively shaping their career paths. Our commitment is to facilitate individuals in pursuing
                  rewarding
        ...
        <div className="bg-gray-200 py-4">
          <div className="container mx-auto text-center">
            ...
            <div className="flex justify-center space-x-4 mt-2">
              ...
              <a href="https://www.termsfeed.com/live/885853a7-633b-4aa6-8759-ba647a08d9f8" className="text-blue-500">EEO
