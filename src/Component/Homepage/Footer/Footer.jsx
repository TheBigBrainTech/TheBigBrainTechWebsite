            ...
            <section className="p-6 bg-gray-100 flex justify-center items-center min-h-45 border-b-2">
                <div className="container mx-auto flex flex-wrap items-start justify-center space-x-6">
                    ...
                    >
                        <div className="flex flex-wrap items-center">
                            ...
                            <div className="w-full md:w-1/2 text-center">
                                <a className="bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-400"
                                   href="/Hire">Hire Us</a>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div
                        ...
                        whileHover={{scale: 1.05}}
                    >
                        <p className="font-bold text-center text-2xl text-gray-600 mb-4">Don&apos;t Miss Out On Offers
                            and
                            Discounts</p>
                        ...
                        <p className="mt-2 text-sm text-center">
                            ...
                            <a href="https://www.termsfeed.com/live/885853a7-633b-4aa6-8759-ba647a08d9f8"
                               className="text-blue-500"> Privacy Policy</a> and
                            <a href="https://www.termsfeed.com/live/885853a7-633b-4aa6-8759-ba647a08d9f8"
                               className="text-blue-500"> Terms of Service</a>.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="container mx-auto">
                    <div className="flex flex-wrap">
                        <div className="w-full lg:w-6/12 mb-8">
                            ...
                            <p className="px-3">
                                The BigBrain Tech takes pride in spearheading cutting-edge initiatives in education and
                                professional
                                growth,
                                specializing in high-demand skill sets. As the leading destination for comprehensive
                                training, talent
                                acquisition, and career transitions, we foster an inclusive community of ambitious
                                professionals who
                                are actively shaping their career paths. Our commitment is to facilitate individuals in
                                pursuing
                                rewarding
                                careers that align with their passions and ambitions, enabling them to flourish and make
                                a meaningful
                    ...
                    <div className="flex justify-center mb-8">
                        <ul className="flex space-x-4">
                            <li><a href="https://www.facebook.com/" className="text-blue-500"><FontAwesomeIcon
                                icon={faSquareFacebook}/> Facebook</a></li>
                            <li><a href="https://twitter.com/i/flow/login?redirect_after_login=%2F%3Flang%3Den"
                                   className="text-blue-500"><FontAwesomeIcon icon={faSquareXTwitter}/> Twitter</a></li>
                            <li><a href="https://www.instagram.com/" className="text-blue-500"><FontAwesomeIcon
                                icon={faSquareInstagram}/> Instagram</a></li>
                            <li><a href="https://www.linkedin.com/"
                                   className="text-blue-500"><FontAwesomeIcon icon={faLinkedin}/> LinkedIn</a></li>
                        </ul>
                    </div>
                </div>
            </footer>
            <div className="bg-gray-200 py-4">
                <div className="container mx-auto text-center">
                    ...
                    <div className="flex justify-center space-x-4 mt-2">
                        ...
                        <a href="https://www.termsfeed.com/live/885853a7-633b-4aa6-8759-ba647a08d9f8"
                           className="text-blue-500">EEO
                            Statement and Legal Notices</a>
