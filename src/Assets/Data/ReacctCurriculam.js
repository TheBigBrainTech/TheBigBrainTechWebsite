export const ReactCurriculum = [
    ...
    },
    {
        ...
        days: [
            ...
            'Snapshot testing, Mocking and spies, Integration testing',
            'End-to-end testing with Cypress, Writing and running Cypress tests, Debugging tests',
            'CI/CD pipelines for front-end applications, Introduction to popular CI/CD tools (GitHub Actions, Travis CI, CircleCI), Setting up a CI/CD pipeline for a React application',
            'Deployment options for front-end applications (Netlify, Vercel, GitHub Pages), Deploying a React application, Final project planning',
        ],
    },
    {
        week: 9,
